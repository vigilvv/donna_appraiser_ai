    ...
    init_state = {
        "objects": [
            {"name": "apple", "description": "A red apple",
                "type": ["item", "food"]},
            {"name": "banana", "description": "A yellow banana",
                "type": ["item", "food"]},
            {"name": "orange", "description": "A juicy orange",
                "type": ["item", "food"]},
...
action_space = [
    Function(
        ...
        args=[Argument(name="object", type="item",
    ...
    Function(
        ...
        args=[Argument(name="object", type="item",
                       description="Object to throw")],
        executable=throw_object
    ),
    Function(
        fn_name="sit",
        fn_description="Take a seat",
        args=[Argument(name="object", type="sittable",
...
main_agent = Worker(
    ...
    description="You are master real estate appraiser. Based on the user input you get appraisals from workers, do meta analysis and output a coheisive price to the user in dollars. You call all worker exactly once and then stop.",
